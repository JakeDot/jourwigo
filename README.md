...
- **Create Cartridge** tab creates a Lua cartridge template (`.lua`) that can be compiled into `.gwc` using jourwigo-compatible tooling.
...
- The integrated approach uses cgeo/cgeo Wherigo runtime classes for robust cartridge execution and jourwigo-style template generation for editor workflows.
